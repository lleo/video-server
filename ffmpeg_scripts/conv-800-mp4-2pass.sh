...
time (
    ...
    #PASS 1
    time ffmpeg -i "$origfn" -codec:v libx264 -profile:v high -preset slow -b:v 500k -maxrate 500k -bufsize 1000k -vf scale=800:-1 -threads 0 -pass 1 -an -f mp4 -y /dev/null

    #PASS 2
    time ffmpeg -i "$origfn" -codec:v libx264 -profile:v high -preset slow -b:v 500k -maxrate 500k -bufsize 1000k -vf scale=800:-1 -threads 0 -pass 2 -codec:a libfdk_aac -b:a 128k -f mp4 -y "$newfn"

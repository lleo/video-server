...
time (
    ...
    #PASS 1
    time ffmpeg -i "$origfn" -codec:v libvpx -quality good -cpu-used 0 -b:v 500k -qmin 10 -qmax 42 -maxrate 500k -bufsize 1000k -threads 8 -vf scale=1024:-1 -an -pass 1 -f webm -y /dev/null

    #PASS 2
    time ffmpeg -i "$origfn" -codec:v libvpx -quality good -cpu-used 0 -b:v 500k -qmin 10 -qmax 42 -maxrate 500k -bufsize 1000k -threads 8 -vf scale=1024:-1 -codec:a libvorbis -b:a 128k -pass 2 -f webm -y "$newfn"

...
(
    ...
    time ffmpeg -i "$origfn" -codec:v libx264 -profile:v high -preset slow -b:v 500k -maxrate 500k -bufsize 1000k -vf scale=1024:436 -threads 0 -codec:a libfdk_aac -b:a 128k -y "$newfn"
